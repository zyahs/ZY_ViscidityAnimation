...
@implementation ZY_ViscidityButton
- (void)layoutSubviews
{
...
- (void)initUI
{
	...
	_smallCircleView.layer.cornerRadius = _smallCircleView.bounds.size.width * 0.5;
